...
def nnmodel(imglen, pixellen, classification, n_channels, n_classes, imageclass):
    ...
    x = Conv2D(16, kernel_size=(1, 1, 4), activation='relu', padding='same')(input)
    x = MaxPooling2D(pool_size=(2, 2, 4))(x)

    x1 = Conv2D(16, kernel_size=(3, 3, 4), activation='relu', padding='same')(input)
    x1 = MaxPooling2D(pool_size=(2, 2, 4))(x1)

    x2 = Conv2D(16, kernel_size=(5, 5, 4), activation='relu', padding='same')(input)
    x2 = MaxPooling2D(pool_size=(2, 2, 4))(x2)
