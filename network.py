...
def nnmodel(imglen, pixellen, classification, n_channels, n_classes, imageclass, metapath, patience):
    ...
    x1 = Conv2D(124, kernel_size=(5, 5), activation='relu', padding='same')(input)
    x1 = AveragePooling2D(pool_size=(2, 2))(x1)
    x2 = Conv2D(124, kernel_size=(3, 3), activation='relu', padding='same')(input)
    x2 = MaxPooling2D(pool_size=(3, 3))(x2)
    x3 = Conv2D(124, kernel_size=(3, 3), activation='relu', padding='same')(input)
    x3 = AveragePooling2D(pool_size=(2, 2))(x3)
    x4 = Conv2D(124, kernel_size=(2, 2), activation='relu', padding='same')(input)
